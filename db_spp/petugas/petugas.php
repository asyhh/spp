...
<div class="container mt-5">
	...
	<a href="petugas.php" class="btn btn-outline-dark"> Petugas</a>
	<a href="petugas.php?url=pembayaran" class="btn btn-outline-dark"> Pembayaran</a>
	<a href="petugas.php?url=logout" class="btn btn-outline-dark"> Logout</a>
